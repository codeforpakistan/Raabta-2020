...
public class OffenceListFragments extends Fragment {
    ...
    private static String PARENT_TITLE_7="Obstructing movment of emergency vehicles.";
    ...
    public static String CHILD_TITLE_8_5="Truck @Rs. 300";
    public static String CHILD_TITLE_8_6="HTV/PSV @Rs. 500";
    ...
    public static String CHILD_TITLE_9_5="Truck @Rs. 300";
    ...
    private void prepareMovieData() {
        ...
        offenceModel_10.setOffence_title(PARENT_TITLE_9);
