...
public class ExpandableListAdapter2 extends BaseExpandableListAdapter {
    ...
    public ExpandableListAdapter2(List<String> parent_list, HashMap<String, List<String>> child_list, Context context) {
    ...
    public View getGroupView(int i, boolean b, View view, ViewGroup viewGroup) {
        ...
        if(view==null){
            ...
            view=layoutInflater.inflate(R.layout.offence_parent_list,null);
        }
    ...
    public View getChildView(int i, int i1, boolean b, View view, ViewGroup viewGroup) {
        ...
        if(view==null){
            LayoutInflater layoutInflater=(LayoutInflater)context.getSystemService(Context.LAYOUT_INFLATER_SERVICE);
            view=layoutInflater.inflate(R.layout.offence_child_list,null);
        }
